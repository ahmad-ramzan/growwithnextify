...
export default function ServicesSection() {
  return (
    <section
      className="relative py-24 px-6 bg-[var(--bg-secondary)] border-y border-[var(--border-light)]"
      data-avatar-section
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="bg-white p-7 rounded-lg shadow-sm border border-[var(--border-light)] flex flex-col hover:shadow-lg hover:border-[var(--brand-blue)] transition-all duration-300 group relative overflow-hidden"
                data-avatar-section
              ...
              >
                ...
                {/* Title */}
                <h3
                  className="text-lg font-bold text-[var(--text-primary)] mb-3 transition-colors duration-300"
                  style={{
                    // CSS custom property for hover color
                  }}
                >
                  <span className="group-hover:text-[var(--brand-green)] transition-colors">
                    {service.title}
                  </span>
                </h3>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-sm font-bold mt-auto pt-5 border-t border-[var(--border-light)] transition-colors duration-300"
